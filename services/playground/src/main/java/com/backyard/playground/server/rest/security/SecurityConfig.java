...
public class SecurityConfig {
    ...
    /**
     * Permit-all security config for the {@code home} profile. No JWT validation —
     * the home jar runs on a trusted local machine.
     */
    @Profile("home")
    @Configuration
    @EnableWebSecurity
    ...
    /**
     * Configures the Spring Security filter chain for all profiles except
     * {@code home}.
     *
     ...
     * the authenticated principal in {@code SecurityContextHolder}. Does NOT reject
     * requests — it only identifies the caller.
     ...
     * pages with JSON bodies matching the {@code ErrorResponse} format used by
     * {@code GlobalExceptionHandler}.
     */
    @Profile("!home")
    @Configuration
    @EnableWebSecurity
    public static class JwtSecured {

        private final JwtAuthenticationFilter jwtAuthenticationFilter;

        public JwtSecured(JwtAuthenticationFilter jwtAuthenticationFilter) {
