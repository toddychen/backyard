 ...
 *
 * <p>
 * The locale is read from {@link ClientLocaleContextHolder}, which is populated
 * by {@code
 * LocaleFilter} on the request thread. Because
 ...
 * thread (e.g. inside a {@code FanOut} parallel call) — the locale is inherited
 * automatically.
 *
 * <p>
