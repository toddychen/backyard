package com.backyard.playground.client.rest.config;
...
import com.backyard.playground.client.rest.interceptor.LoggingInterceptor;
import com.backyard.playground.client.rest.interceptor.QueryParamInterceptor;
...
public class RestClientConfig {
    ...
    public RestClientConfig(CircuitBreakerRegistry cbRegistry, RetryRegistry retryRegistry) {
     ...
     * methods {@code getTeamGames} and {@code getGameDetails}:
     *
     * <pre>
     *
     ...
     * resilience4j.circuitbreaker.instances
     *     .yahoosports-getTeamGames.sliding-window-size=10
     * resilience4j.circuitbreaker.instances
     *     .yahoosports-getTeamGames.wait-duration-in-open-state=30s
     * resilience4j.circuitbreaker.instances
     *     .yahoosports-getGameDetails.minimum-number-of-calls=5
     * resilience4j.circuitbreaker.instances
     *     .yahoosports-getGameDetails.sliding-window-size=10
     * resilience4j.circuitbreaker.instances
     *     .yahoosports-getGameDetails.wait-duration-in-open-state=30s
     *
     * # retry — one instance per client (config only, not shared state)
